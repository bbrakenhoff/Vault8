...
export const testRetrospectiveElements: RetrospectiveElementStub[] = [
  // Set the Stage
  {
    ...
    phase: ['setTheStage'],
    instruction: 'Ask participants to pick a Hogwarts house and share how it aligns with their sprint experience.'
  },
  {
    id: 'setTheStage2',
    ...
    phase: ['setTheStage'],
    instruction: 'Participants pair Taylor Swift lyrics with sprint themes or outcomes.'
  },
  {
    id: 'setTheStage3',
    ...
    phase: ['setTheStage'],
    instruction: 'Share famous Disney quotes and ask participants to guess the movie.'
  },
  {
    id: 'setTheStage4',
  ...
  // Gather Data
  {
    ...
    attendanceOptions: ['Online', 'Offline'],
    phase: ['gatherData'],
    instruction: 'Use a visual map to highlight tasks completed, in progress, and blocked.'
  },
  {
    id: 'gatherData2',
    ...
    attendanceOptions: ['Online'],
    phase: ['gatherData'],
    instruction: 'Create a playlist of FLETCHER songs to represent team mood and progress.'
  },
  {
    id: 'gatherData3',
    ...
    attendanceOptions: ['Offline'],
    phase: ['gatherData'],
    instruction: 'Team members vote on their favorite Disney-inspired meals to reflect sprint satisfaction.'
  },
  {
    id: 'gatherData4',
  ...
  // Generate Insights
  {
    ...
    instruction: 'Match Ed Sheeran lyrics to the team’s challenges and achievements.'
  },
  {
    ...
    attendanceOptions: ['Offline'],
    phase: ['generateInsights'],
    instruction: "Break down 'Horcrux-like' tasks that feel overwhelming into manageable pieces."
  },
  {
    ...
    attendanceOptions: ['Online'],
    phase: ['generateInsights'],
    instruction: 'Discuss team behaviors as heroic or villainous in achieving sprint goals.'
  },
  {
  ...
  },
  {
    ...
    attendanceOptions: ['Online'],
    phase: ['decideWhatToDo'],
    instruction: "Identify sprint actions aligned with the emotional tone of Taylor Swift’s 'Red' album."
  },
  {
    id: 'decideWhatToDo3',
    ...
    attendanceOptions: ['Offline'],
    phase: ['decideWhatToDo'],
    instruction: 'Design a dream roadmap inspired by Disney stories and characters.'
  },
  {
    id: 'decideWhatToDo4',
    ...
    attendanceOptions: ['Online', 'Offline'],
    phase: ['decideWhatToDo'],
    instruction: "Define key action items as 'treasure map routes' and prioritize them based on 'hidden gold' (value)."
  },
